        ...
        <HomeContainer>
            ...
            <CardsGrid>
                 <NavCard 
                    ...
                    role="button" tabIndex={0} onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && navigate('/scoring')}>
                    <NavCardIcon><TipsIcon /></NavCardIcon>
                    <h2>评分标准和考试需知</h2>
                    <p>深入了解雅思官方口语评分的四大维度、考试基本信息与核心备考建议。</p>
                </NavCard>

                <NavCard onClick={() => navigate('/tips')} role="button" tabIndex={0} onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && navigate('/tips')}>
                    <NavCardIcon><TipsIcon /></NavCardIcon>
                    <h2>回答技巧</h2>
                    <p>学习 Part 1/2/3 的核心答题策略与高分技巧，让你的表达更流利、更有逻辑。</p>
                </NavCard>

                <NavCard onClick={() => navigate('/bank')} role="button" tabIndex={0} onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && navigate('/bank')}>
